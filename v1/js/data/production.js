  ...
  projects: [
    { slug:'heart', title:'H.E.A.R.T.', status:'active', featured:true,
      ...
      episodes:[
        ...
        {title:'Honor', state:'production', synopsis:'Honor means high respect, moral integrity, or a public award that shows great appreciation. What does it mean to students and teachers? How is it applied in day-to-day school life? In this episode we will answer all of the above and featuring a special guest.', stage:3},
        {title:'Empathy', state:'production', synopsis:'[WIP]', stage:3},
        {title:'Accountability', state:'production', synopsis:'[WIP]', stage:2},
